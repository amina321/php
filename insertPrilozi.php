...
<TR height="50" > 
<TD colspan="2"><center><b>Unesi prilog<b><center></TD>
</TR>

<TR> <TD>Id</TD> <TD><input name="idprilozi" type="text" value="<?php echo $idprilozi; ?>"></TD> </TR>
...
$idprilozi = mysqli_real_escape_string($conn, $_POST['idprilozi']);
...
if ($idprilozi == '' || $naziv == '' || $gramaza == '' || $cijena == '')
{
...
{
mysqli_query($conn, "INSERT prilozi SET idprilozi = $idprilozi, naziv='$naziv', gramaza='$gramaza', cijena='$cijena'")
